...
class PersonalQuizController extends Controller
{
    ...
    public function show()
    {
        ...
        $total_responses = Question::where('response_type', 'bool')->withCount('responses')->firstOrFail()->responses_count;
        ...
        return view('personal-quiz')->with([
            ...
            'responses' => $all_ques
                ->map(
                    fn ($q) => [
                        'user_response' => $user_responses->where('question_id', $q->id)->firstOrFail()->value,
