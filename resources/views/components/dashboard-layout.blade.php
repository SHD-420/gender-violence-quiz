...
<body class="bg-gray-200">
    <nav class="grid grid-cols-5 text-purple-800 w-8/12 mx-auto py-4">
        <a href="{{ route('dashboard') }}"
            ...
            <p class="leading-none mt-2">Inicio</p>
        </a>
        <a href="{{ route('knowledge-quiz') }}"
            ...
            <p class="leading-none mt-2">Quiz de Conocimiento</p>
        </a>
        <a href="{{ route('personal-quiz') }}"
            ...
            <p class="leading-none mt-2">Quiz Personal</p>
        </a>
        <a href="{{ route('profile') }}"
            ...
            <p class="leading-none mt-2">Editar Perfil</p>
        </a>
