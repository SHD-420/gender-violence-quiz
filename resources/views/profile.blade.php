<x-dashboard-layout>
    @if ($errors->any())
        <p class="mb-4 bg-red-200 w-1/2 mx-auto rounded-md px-4 py-2 text-red-600 font-semibold">
            An error occured. Please retry!
        </p>
    @endif
    <form class="w-1/2 mx-auto p-8 shadow-xl bg-white rounded-md mt-12" method="POST" action="{{ route('profile') }}">
        @csrf
