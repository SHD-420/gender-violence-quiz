<x-home-layout>
    <div class="py-2 px-12 mx-auto w-1/2 rounded-md bg-white shadow-xl">
        <div class="grid grid-cols-2 gap-x-2">
            <a href="{{ route('login') }}" class="font-semibold text-center py-2 hover:bg-orange-100 rounded-md">Login</a>
            <button class="bg-orange-200 py-2 text-orange-600 font-semibold rounded-md">Register</button>
            <form class="col-span-2 py-8" method="POST" action="{{ route('register') }}">
                @csrf
                <h4 class="text-2xl font-bold text-gray-600 pb-2 border-b-2  mb-4">Register a
                    new
                    account</h4>
                <div class="mb-4">
                    <label for="email" class="text-sm">Enter your email
                        @error('email')
                ...
                <div class="mb-8">
                    <label for="password" class="text-sm text-center">Set a password
                        @error('password')
                            <span class="text-red-600 ml-2 font-semibold">
                ...
                <button type="submit"
                    class="text-center w-full bg-purple-800 text-white font-semibold py-2 rounded-md hover:bg-purple-700">Submit</button>
            </form>
        </div>
    </div>
</x-home-layout>
